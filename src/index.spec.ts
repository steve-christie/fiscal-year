...
describe("getFiscalYearOfDate Tests", () => {
    ...
    it("When start month passed in is less than 0, error is thrown", () => {
        expect(() => getFiscalYearOfDate(new Date("2023-05-01"), -1))
            .to
            .throw("FY Start Month (-1) must be a number from 0 to 11")
    })

    it("When start month passed in is greater than 11, error is thrown", () => {
        expect(() => getFiscalYearOfDate(new Date("2023-05-01"), 12))
            .to
            .throw("FY Start Month (12) must be a number from 0 to 11")
    })
